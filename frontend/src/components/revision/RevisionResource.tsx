  ...
  return (
    ...
    >
      ...
      {isLoading ? (
        ...
        <tbody className="bg-white dark:bg-slate-700 dark:text-white mt-4 h-8 rounded w-full">
          {resources?.length ? (
            resources
              .sort(function (a, b) {
                return (
    ...
    <>
      ...
      {isLoading ? (
        ...
        <div className="h-full overflow-y-auto ">
          <pre
            className="bg-white dark:bg-slate-700 dark:text-white rounded p-4 font-medium text-base font-sf-mono"
