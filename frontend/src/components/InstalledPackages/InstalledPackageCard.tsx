...
export default function InstalledPackageCard({
  ...
  return (
    <div
      ...
      } text-xs grid grid-cols-12 items-center bg-white dark:bg-slate-700 dark:text-white rounded-md p-2 py-6 my-2 custom-shadow border-l-4 border-l-[${statusColor}] cursor-pointer ${
